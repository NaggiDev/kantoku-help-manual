    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-12 md:p-24 bg-gradient-to-br from-slate-900 to-slate-800 text-white relative">
      ...
      <div className="text-center max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link href="/download" className="block bg-slate-700 hover:bg-slate-600 p-6 rounded-lg transition-colors shadow-md group">
            <div className="flex items-center mb-3">
              ...
              <h3 className="text-xl font-semibold">{t('downloadButton', 'download')}</h3>
            </div>
            <p className="text-slate-300">{t('subtitle', 'download')}</p>
          </Link>
        </div>
